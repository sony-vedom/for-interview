import { SbtRejectionStandardsEdit } from '../../model'
import { SbtRejectionStandardsEditDto } from 'entities/sbt-rejection-standards/item/api/dto'

export const mapEditSbtRejectionStandards = (dto: SbtRejectionStandardsEdit): SbtRejectionStandardsEditDto => ({
