...
import { CreateMainInfoPipeDTO } from './base-type/create-pipe.dto'

type OverrideCreateSbtPipeBodyDTO = 'average_wall_thickness' | 'total_length'

export interface CreateSbtPipeBodyDTO
    extends Omit<
        ISbtDTOPipeBody,
        'pipe_body_class' | OverrideCreateSbtPipeBodyDTO
    > {
    average_wall_thickness: number
    total_length: number
}

type OverrideCreateSbtNippleDTO =
...
export interface CreateSbtNippleDTO
    extends Omit<
        ISbtDTONipple,
        | 'condition_lock_connection_nipple'
        | 'lock_connection_class_nipple'
        | OverrideCreateSbtNippleDTO
    > {
...
type OverrideCreateSbtCouplingDTO =
...
export interface CreateSbtCouplingDTO
    extends Omit<
        ISbtDTOCoupling,
        | 'condition_lock_connection_coupling'
        | 'lock_connection_class_coupling'
        | OverrideCreateSbtCouplingDTO
    > {
...
export type CreateSbtDTO = CreateSbtPipeBodyDTO &
    CreateSbtNippleDTO &
    CreateSbtCouplingDTO &
    CreateMainInfoPipeDTO & {
